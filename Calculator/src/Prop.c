...
do
{
	...
	printf("С чем вы хотите произвести действие, с векторами или с переменными?\n");
	printf("(Введите v - если с векторами или любой другой символ с переменными:  ");
    scanf(" %с", &mode);
